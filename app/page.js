          ...
          <div className={styles.locationGrid}>
            <ScrollReveal direction="left" className={styles.locationContent}>
              ...
              <div className={styles.locationDetails}>
                <a href="https://www.google.com/maps/search/Chinatown+Complex+01-154+Singapore+050335" target="_blank" rel="noopener noreferrer" className={styles.locationItem}>
                ...
                <a href="tel:+6585019131" className={styles.locationItem}>
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--color-gold)" strokeWidth="2">
